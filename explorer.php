...
<b>
    ...
    <center><img src="https://images.prod.babyshopgroup.io/images/PM-29528%23a/256x256.jpeg" alt="Weekend Explorer"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Weekend Explorer'");
...
$queryP = mysqli_query($connection, "select ProductName, ProductPrice, ProductDescription, Qty from Products WHERE ProductName = 'Weekend Explorer'");
