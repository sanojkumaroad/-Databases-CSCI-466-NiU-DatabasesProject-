...
<b>
    ...
    <center><img src="https://www.palazzodiscarpe.gr/wp-content/uploads/2022/10/IMG_5672-256x256.jpg" alt="Urban Street Boots"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Urban Street Boots'");
