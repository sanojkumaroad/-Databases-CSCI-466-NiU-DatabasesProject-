...
<b>
    ...
    <center><img src="https://dodo.ac/np/images/f/fc/Comfy_Sandals_%28White%29_NH_Icon.png" alt="Summer Breeze Sandals"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Summer Breeze Sandals'");
