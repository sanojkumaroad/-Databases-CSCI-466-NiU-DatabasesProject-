...
<b>
    ...
    <center><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJFrKN-pcSr1SI6m-NtqQFy34cl6P1hYGWRg&usqp=CAU" alt="Crossfit Trainer"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Crossfit Trainer'");
