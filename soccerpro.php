...
<b>
    ...
    <center><img src="https://www.svsports.com/cdn/shop/products/gw4609-2_256x.jpg?v=1679952000" alt="Soccer Pro Elite"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Soccer Pro Elite'");
...
$queryP = mysqli_query($connection, "select ProductName, ProductPrice, ProductDescription, Qty from Products WHERE ProductName = 'Soccer Pro Elite'");
