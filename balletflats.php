...
<b>
    ...
    <center><img src="https://solltrend.com/wp-content/uploads/2023/10/soll-vivian-bei-1-256x256.webp" alt="Ballet Flats"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Ballet Flats'");
