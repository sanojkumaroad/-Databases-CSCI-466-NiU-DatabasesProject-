...
<b>
    ...
    <center><img src="https://www.svsports.com/cdn/shop/products/1110519-bfbg_256x.jpg?v=1654206580" alt="Tech Runner"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Tech Runner'");
