...
<b>
    ...
    <center><img src="https://images.prod.babyshopgroup.io/images/PM-55100%23a/256x256.jpeg" alt="Snow Explorer Boots"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Snow Explorer Boots'");
...
$queryP = mysqli_query($connection, "select ProductName, ProductPrice, ProductDescription, Qty from Products WHERE ProductName = 'Snow Explorer Boots'");
