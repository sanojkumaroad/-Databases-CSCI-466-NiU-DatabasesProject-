...
CREATE TABLE Order_Info(OrderID INT AUTO_INCREMENT PRIMARY KEY, CustomerID INT, OrderDate DATETIME, OrderTotal FLOAT, OrderStatus VARCHAR(50), FOREIGN KEY (CustomerID) REFERENCES User_Customer(CustomerID));
