...
<b>
    ...
    <center><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtIVdUiPd3h14bP5oGIfMI8mcST1WMFlytFw&usqp=CAU" alt="Skateboard Pro"></center>
...
$queryProduct = mysqli_query($connection, "SELECT ProductID, ProductName, ProductPrice, ProductDescription, Qty FROM Products WHERE ProductName = 'Skateboard Pro'");
